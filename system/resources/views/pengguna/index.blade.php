			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
				<div class="panel panel-default">
					<div class="panel-body">
						<td><img src="{{url('public/adm', $artikel->foto)}}" width="650px" height="350px" style="margin-right: 360px;"> </td>
						...
						<h4>{{$artikel->tab}}</h4>
						<p>{{$artikel->konten}}[...]</p>
						<a href="javascript: void(0);" class="btn btn-default"> Selengkapnya...</a>
					</div>
				</div>
			</div>
			@endif
	...
	<div class="col-sm-6 col-md-4 col-lg-4">
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<td><img src="{{url('public')}}/adm/Politap.jpg" width="200px" height="200px" style="margin-right: 360px;" class="img-thumbnail img-responsive">
				<br>
				<br>
				...
				<div class="row">
					...
					@if(Auth::user()->id == $artikel->id_user)
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
							<td><img src="{{url('public/adm', $artikel->foto)}}" width="350px" height="200px" style="margin-right: 360px;" class="img-thumbnail img-responsive">
						</div>
