        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="form" data-parsley-validate="" novalidate="" action="{{url('artikel/update', $artikel->id_artikel)}}" method= "post">
                    ...
                    <div class="form-group row">
                        <label for="inputEmail2" class="col-3 col-lg-2 col-form-label text-right">Foto Artikel</label>
                        <div class="col-9 col-lg-10">
                            <input id="inputEmail2" type="file" class="form-control" name="foto" value="{{$artikel->foto}}">
                        </div>
                    </div>
