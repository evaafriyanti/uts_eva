...
<html lang="en">
<head>
    <title>Register Penggunas</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="container-login100" style="background-image: url('{{url('public')}}/login/images/photo1.png');">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
            <form class="login100-form validate-form" action="{{url('register/store')}}" method="post">
            @csrf
                <span class="login100-form-title p-b-37">
                    Register Pengguna
                </span>
                <div class="wrap-input100 validate-input m-b-20" data-validate="Nama masih kosong">
                    <input class="input100" type="text" name="nama" placeholder="Masukkan Nama Lengkap">
                    <span class="focus-input100" data-symbol="&#xf206;"></span></i>
                </div>
                <div class="wrap-input100 validate-input m-b-20" data-validate="Username masih kosong">
                    <input class="input100" type="text" name="username" placeholder="Masukkan Username">
                    <span class="focus-input100" data-symbol="&#xf206;"></span></i>
                </div>
                <div class="wrap-input100 validate-input m-b-25" data-validate="Password masih kosong">
